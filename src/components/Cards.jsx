  ...
  return (
    <div className="card">
      <div className="content">
        <div className="back">
        <div className="back-content" style={{backgroundImage: `url(${props.image})`}}>
            <svg
              stroke="#ffffff"
        ...
        <div className="front">
          ...
          <div className="front-content">
            <small className="badge"><a href={props.view} className="linking" rel='noreferrer' target="_blank">view</a></small>
